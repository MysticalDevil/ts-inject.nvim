...
assert_injected_node("tests/fixtures/basic.c", "c", "nop", "word")
assert_injected_node("tests/fixtures/basic.c", "c", "mov %0, %1", "word")
assert_injected_node("tests/fixtures/basic.c", "c", "cli", "word")
assert_injected_node("tests/fixtures/basic.c", "c", "push", "word")
